...
# Hollow out the house from the bottom
...
# Add side windows based on sketch data
side_window_width = 26
side_window_height = 26
side_window_z = 5

swin1 = (
    cq.Workplane("YZ")
    .workplane(offset=-house_length / 2.0)
    .center(-26, side_window_z)
    .box(side_window_width, side_window_height, window_depth * 2.0)
)
swin2 = (
    cq.Workplane("YZ")
    .workplane(offset=-house_length / 2.0)
...
result = result.cut(swin1).cut(swin2)
